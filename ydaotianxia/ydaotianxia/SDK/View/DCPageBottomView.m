...
-(UIButton *)listBtn
{
    if(_listBtn == nil)
    {
        ...
        [_listBtn setImage:[UIImage imageNamed:ImagePath(@"list")] forState:UIControlStateNormal];
    }
    return _listBtn;
}
-(UIButton *)nightModeBtn
{
    if(_nightModeBtn == nil)
    {
        ...
        [_nightModeBtn setImage:[UIImage imageNamed:ImagePath(@"read_night")] forState:UIControlStateNormal];
        [_nightModeBtn setImage:[UIImage imageNamed:ImagePath(@"read_default")] forState:UIControlStateSelected];
