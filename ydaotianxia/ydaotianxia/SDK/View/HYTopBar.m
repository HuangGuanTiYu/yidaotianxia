...
- (void)addTitleBtn:(NSString *)title {
    ...
    [btn setTitleColor:RGBCOLOR_HEX(0x549bfe) forState:UIControlStateSelected];
...
- (void)layoutSubviews {
    ...
    for (int i = 0 ; i < self.btnArray.count; i++) {
        ...
        btn.frame = CGRectMake(i * HYScreenW / self.btnArray.count, 0, HYScreenW / self.btnArray.count, btnH);
